...
classifier = SVC(random_state=random_state, C=0.5, gamma=0.00025)
clf = classifier.fit(X, y)

dualcoef = clf.dual_coef_
supvectors = clf.support_vectors_

filename = 'dualcoef_median_parameter.pckl'
filename2 = 'support_vectors_median_parameter.pckl'
pickle.dump(dualcoef, open(filename, 'wb'))
pickle.dump(supvectors, open(filename2, 'wb'))

pkl_filename = 'SVM_model_median_parameter.pckl'
